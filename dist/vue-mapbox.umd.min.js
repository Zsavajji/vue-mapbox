  ...
  return (function(t) {
      ...
      t.exports = function(t, e, r, y, b, g, O) {
        ...
        if (
          (M &&
            ...
            w !== Object.prototype &&
              w.next &&
              (u(w, S, !0), n || "function" == typeof w[l] || a(w, l, v))),
          P &&
            I &&
            I.name !== m &&
            ((E = !0),
          ...
          if (
            ((x = { values: P ? L : j(m), keys: g ? L : j(h), entries: k }), O)
          )
          ...
          [
            ...
            function(t, e) {
              ...
              while (_ < p.length) {
                ...
                if (
                  null === S ||
                  (j = l(c(g.lastIndex + (y ? 0 : _)), p.length)) === x
                )
                  _ = a(p, _, h);
                else {
                  if ((w.push(p.slice(x, _)), w.length === O)) return w;
                  for (var P = 1; P <= S.length - 1; P++)
                    if ((w.push(S[P]), w.length === O)) return w;
                  _ = x = j;
                }
              }
    ...
    "794b": function(t, e, r) {
      t.exports =
        ...
        !r("294c")(function() {
          return (
            7 !=
            Object.defineProperty(r("1ec9")("div"), "a", {
              get: function() {
                return 7;
              }
            }).a
      ...
      r("214f")("replace", 2, function(t, e, r, m) {
        return [
          ...
          function(t, e) {
            ...
            for (var _ = "", w = 0, j = 0; j < g.length; j++) {
              O = g[j];
              for (
                var S = String(O[0]),
              ...
              P >= w && ((_ += p.slice(w, P) + k), (w = P + S.length));
            }
            return _ + p.slice(w);
          }
        ];
    ...
    fb15: function(t, e, r) {
      ...
      var o = function() {
        ...
        a = (r("8e6e"), r("ac6a"), r("cadf"), r("456d"), r("551c"), r("85f2")),
        c = r.n(a);
      function s(t, e, r) {
        return (
          e in t
            ...
            $_emitEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$emit(t, f({ map: this.map, component: this }, e));
            },
            $_emitMapEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$_emitEvent(t.type, f({ mapboxEvent: t }, e));
            }
          }
        },
        p = {
      ...
      function v() {
        ...
        return (
          Object.entries(h).forEach(function(e) {
            t[e[0]] = function(t, r) {
              return m.call(this, e[0], e[1].bind(this), t, r);
            };
          }),
          t
        );
      ...
      var $ = {
          name: "GlMap",
          mixins: [y, S, O, l],
          props: E({ mapboxGl: { type: Object, default: null } }, d),
          provide: function() {
            var t = this;
            return {
              get mapbox() {
      ...
      var k = L(I, o, i, !1, null, null, null),
        M = k.exports;
      function T(t, e) {
        var r = Object.keys(t);
        if (Object.getOwnPropertySymbols) {
            ...
            $_emitSelfEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$_emitMapEvent(t, C({ control: this.control }, e));
            },
        ...
        R = {
          ...
          created: function() {
            ...
            (this.control = new t(this.$props)),
              this.$_addControl(),
              this.$_bindSelfEvents(Object.keys(B), this.control);
          },
          methods: {
            trigger: function() {
      ...
      var W = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
        H = {
          click: "click",
        ...
        rt = {
          ...
          methods: {
            $_addPopup: function() {
              ...
              this.$_bindSelfEvents(Object.keys(et), this.popup),
        ...
        methods: {
          $_deferredMount: function() {
            if (
              ...
              var t = ht({ type: "geojson" }, this.source);
              try {
      ...
      var bt = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = yt({ type: "image" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
            ...
            this.$_addLayer(), this.$_bindLayerEvents(at), (this.initial = !1);
          },
          $_addLayer: function() {
            var t = this.map.getLayer(this.layerId);
            if (t) {
      ...
      var xt = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = Ot({ type: "canvas" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
      ...
      var jt = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = wt({ type: "video" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
      ...
      var Et = {
        ...
        methods: {
          $_deferredMount: function() {
            var t = Pt({ type: "vector" }, this.source);
            this.map.on("dataloading", this.$_watchSourceLoading);
            try {
              this.map.addSource(this.sourceId, t);
            } catch (e) {
      ...
      var Lt = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = It({ type: "raster" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
        ...
        Tt = A,
        Ct = pt,
        Dt = { withEvents: l, withSelfEvents: D, asControl: A, asLayer: pt },
        At = M,
        Ft = F,
        Bt = R,
        Rt = N,
